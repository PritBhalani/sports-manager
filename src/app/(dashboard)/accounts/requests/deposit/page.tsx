...
export default function RequestDepositPage() {
  ...
  const fetchDeposits = async () => {
    ...
    try {
      // API expects: { searchQuery: { status, fromDate, toDate, userId }, params: { pageSize, groupBy, page, orderBy, orderByDesc } }
      ...
      <Card padded={false} className="overflow-hidden">
        ...
        <div className="border-b border-border px-5 pt-5 sm:px-6">
          <div className="flex gap-8">
            <Link href="/accounts/requests/deposit" className={tabClass(true)}>
