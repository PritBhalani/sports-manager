...
// Wrap the lucide icons in local components so the sidebar stays
// "icon-mapping only" (no lucide imports spread across Sidebar.tsx).
import {
  Users,
  Trophy,
  Dice5,
...
export function IconTransaction({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconRequest({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function IconTrophy({ className }: IconProps) {
  // Sports icon (sidebar "Sports" parent)
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function IconDice5({ className }: IconProps) {
...
export function IconLink2({ className }: IconProps) {
...
export function IconBarChart3({ className }: IconProps) {
...
export function IconGamepad2({ className }: IconProps) {
...
export function IconImageIcon({ className }: IconProps) {
...
export function IconPlugZap({ className }: IconProps) {
...
export function IconFileCheck2({ className }: IconProps) {
...
export function IconBetlist({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconReferrals({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function IconGateways({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconCurrency({ className }: IconProps) {
  return (
    ...
    >
      <path fill="none" d="M0 0h24v24H0z" />
      <path d="M12.89 11.1c-1.78-.59-2.64-.96-2.64-1.9 0-1.02 1.11-1.39 1.81-1.39 1.31 0 1.79.99 1.9 1.34l1.58-.67c-.15-.45-.82-1.92-2.54-2.24V5h-2v1.26c-2.48.56-2.49 2.86-2.49 2.96 0 2.27 2.28 2.91 3.35 3.31 1.58.56 2.28 1.07 2.28 2.03 0 1.13-1.05 1.61-1.98 1.61-1.82 0-2.34-1.87-2.4-2.09l-1.66.67c.63 2.19 2.28 2.78 2.9 2.96V19h2v-1.24c.4-.09 2.9-.59 2.9-3.22 0-1.39-.61-2.61-3.01-3.44zM3 21H1v-6h6v2H4.52c1.61 2.41 4.36 4 7.48 4a9 9 0 0 0 9-9h2c0 6.08-4.92 11-11 11-3.72 0-7.01-1.85-9-4.67V21zm-2-9C1 5.92 5.92 1 12 1c3.72 0 7.01 1.85 9 4.67V3h2v6h-6V7h2.48C17.87 4.59 15.12 3 12 3a9 9 0 0 0-9 9H1z" />
    </svg>
  );
}
...
export function IconAnnouncement({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function IconLosingCommission({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconGGR({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconBlockedPlayers({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconBlockedPlayerHistory({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconDemoPlayers({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconNthDeposit({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function IconFTD({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
    ...
    >
      <g></g>
      <path d="M5.166 8.803l-4.371-3.956 0.67-0.741 3.773 3.413 4.204-3.026 5.593 6.25v-2.285h1v4.036h-4.036v-1h2.366l-5.069-5.665-4.13 2.974zM0 16v1h17v-1h-17z"></path>
    </svg>
  );
}

export function IconZeroDepositPlayers({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconInactivePlayers({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconPlayerMaster({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconFraudLogs({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function IconFlags({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function IconMyProfile({ className }: IconProps) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
      ...
      className={className}
    >
      <path d="M3.78307 2.82598L12 1L20.2169 2.82598C20.6745 2.92766 21 3.33347 21 3.80217V13.7889C21 15.795 19.9974 17.6684 18.3282 18.7812L12 23L5.6718 18.7812C4.00261 17.6684 3 15.795 3 13.7889V3.80217C3 3.33347 3.32553 2.92766 3.78307 2.82598ZM12 11C13.3807 11 14.5 9.88071 14.5 8.5C14.5 7.11929 13.3807 6 12 6C10.6193 6 9.5 7.11929 9.5 8.5C9.5 9.88071 10.6193 11 12 11ZM7.52746 16H16.4725C16.2237 13.75 14.3163 12 12 12C9.68372 12 7.77619 13.75 7.52746 16Z"></path>
    </svg>
  );
}
